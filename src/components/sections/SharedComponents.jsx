// Shared UI components for sections
import React, { useState } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { ChevronDown, HelpCircle } from 'lucide-react';

// Premium Card wrapper
export const PremiumCard = ({ children, index = 0 }) => (
    <motion.div
...
export const BeginnerHint = ({ text }) => (
    <motion.div
...
export const Section = ({ icon: Icon, title, badge, children, defaultOpen = false, hint = null, isBeginner = false }) => {
...
export const GlowNumber = ({ number, size = 'lg', color = 'purple' }) => (
...
export const ProgressBar = ({ value, color = 'purple', label, showValue = true }) => {
...
export const StatCard = ({ icon: Icon, label, value, sublabel, gradient = 'from-purple-500/20 to-pink-500/10' }) => (
...
export default { PremiumCard, BeginnerHint, Section, GlowNumber, ProgressBar, StatCard };
